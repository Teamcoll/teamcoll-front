const Terms = () => (
  <>
    ...
    <p>Welcome to Teamcoll!</p>

    <p>
      These terms and conditions outline the rules and regulations for the use
      of Teamcoll's Website, located at teamcoll.com.
    </p>

    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use Teamcoll if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing Teamcoll, you agreed to use
      cookies in agreement with the Teamcoll's Privacy Policy.
    </p>
    ...
    <p>
      Unless otherwise stated, Teamcoll and/or its licensors own the
      intellectual property rights for all material on Teamcoll. All
      intellectual property rights are reserved. You may access this from
      Teamcoll for your own personal use subjected to restrictions set in these
      terms and conditions.
    </p>

    <p>You must not:</p>
    <ul>
      <li>Republish material from Teamcoll</li>
      <li>Sell, rent or sub-license material from Teamcoll</li>
      <li>Reproduce, duplicate or copy material from Teamcoll</li>
      <li>Redistribute content from Teamcoll</li>
    </ul>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Teamcoll does
      ...
      Teamcoll,its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, Teamcoll shall not be liable for the
    ...
    <p>
      Teamcoll reserves the right to monitor all Comments and to remove any
    ...
    <p>
      You hereby grant Teamcoll a non-exclusive license to use, reproduce, edit
    ...
    <p>
      ...
      hyperlink compensates the absence of Teamcoll; and (d) the link is in the
    ...
    <p>
      ...
      e-mail to Teamcoll. Please include your name, your organization name,
    ...
    <p>
      No use of Teamcoll's logo or other artwork will be allowed for linking
